...
<nav>
    <ul>
        ...
        <li><a href="restaurants-in-tirumala/">Restaurants</a></li>
...
<div class="user-containar">
    ...
    <div class="mobile-bottom-nav">
        <div class="mobile-nav-items">
            ...
            <a href="restaurants-in-tirumala/" class="mobile-nav-item">
                <svg class="icon" viewBox="0 0 24 24">
            ...
            <a href="login.php" class="mobile-nav-item mobile-login-link">
                <img src="img/account_circle.svg" alt="profile icon symbol">
                <span>Login</span>
            </a>
