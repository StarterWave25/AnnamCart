...
function connectToServer() {
    ...
    ws.addEventListener('open', () => {
        ...
        if (location.href != 'http://localhost/AnnamCart/tirumala/restaurant-admin/active-orders.php' && location.href != 'http://localhost/AnnamCart/tirumala/restaurant-admin/accepted-orders.php') {
