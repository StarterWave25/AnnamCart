...
function connectToServer() {
    ...
    ws.addEventListener('open', () => {
        ...
        if (location.href != 'http://localhost/AnnamCart/tirumala-food-delivery/restaurant-admin/active-orders.php' && location.href != 'http://localhost/AnnamCart/tirumala-food-delivery/restaurant-admin/accepted-orders.php') {
